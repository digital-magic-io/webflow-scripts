...
const validateNonEmpty = (field) => (0, exports.validateInput)(field, (value) => !!value && value.length > 0, () => 'This field must be filled!');
exports.validateNonEmpty = validateNonEmpty;
const validateEmail = (field) => (0, exports.validateInput)(field, (value) => !!value && value.includes('@'), () => 'Invalid email!');
